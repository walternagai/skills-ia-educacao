...
6. **Valorizar o processo investigativo** sobre o produto final — avaliar a qualidade das perguntas, a profundidade da análise, a originalidade da reflexão
7. **Fornecer exemplos concretos**: tribunal da verdade (julgar afirmações geradas por IA), debate com IA (usar IA como oponente argumentativo), detetive de fake news (rastrear desinformação com e sem IA)
