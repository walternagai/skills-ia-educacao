...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{clp{4cm}X}
    ...
    \addlinespace
    \textbf{2} & Plan. Assistido por IA & Idea{\c c}{\~a}o, \emph{brainstorming}, esbo{\c c}os e estrutura{\c c}{\~a}o & Do estudante; a IA atua apenas na fase inicial preparat{\'o}ria. \\
    \addlinespace
