...
O reposit{\'o}rio \texttt{skills-ia-educacao} constitui um acervo documental e tecnol{\'o}gico concebido para preencher a lacuna entre as diretrizes normativas (como o Referencial do MEC e as resolu{\c c}{\~o}es universit{\'a}rias, e.g., da UNIFEI \cite{unifei2025graduacao}) e a pr{\'a}tica cotidiana do corpo docente.

Em vez de exigir que cada professor se torne um especialista em engenharia de \emph{prompts} complexos, o reposit{\'o}rio disponibiliza \textbf{62 skills tem{\'a}ticas} e \textbf{6 subagentes aut{\^o}nomos} desenvolvidos especificamente para operar em ambientes de linha de comando baseados no \textbf{OpenCode} (\url{https://opencode.ai}). 
