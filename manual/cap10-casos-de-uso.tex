...
\begin{dicaopencode}
\textbf{Valida{\c c}{\~a}o emp{\'i}rica dos roteiros deste cap{\'i}tulo}: os cinco casos de uso (Casos~1 a~5) e os cinco cen{\'a}rios STHEM desta se{\c c}{\~a}o foram desenhados sobre o comportamento real do OpenCode (vers{\~a}o 1.18.29, modo headless \texttt{opencode run}): os quatro casos de uso originais e os cinco cen{\'a}rios STHEM foram executados, com as skills citadas efetivamente carregadas pela ferramenta \texttt{skill()} e os artefatos esperados produzidos (planos, rubricas com r{\'o}tulos can{\^o}nicos, feedbacks tridimensionais e ConcepTests). A disponibilidade de modelos, a sele{\c c}{\~a}o autom{\'a}tica de skills e o formato da delega{\c c}{\~a}o podem variar conforme a vers{\~a}o e o provedor. Os arquivos de subagentes deste acervo n{\~a}o fixam um modelo: quando instalados na configura{\c c}{\~a}o global ou no projeto, eles usam o modelo selecionado pelo agente principal. Se a men{\c c}{\~a}o \texttt{@subagente} n{\~a}o aparecer, siga as instru{\c c}{\~o}es de instala{\c c}{\~a}o de subagentes do Cap{\'i}tulo~\ref{cap:instalacao}.
\end{dicaopencode}
