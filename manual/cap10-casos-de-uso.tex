...
\begin{table}[tbp]
  ...
  \begin{tabularx}{\linewidth}{p{6.5cm}X}
    ...
    \addlinespace
    Gerar feedback formativo inclusivo para estudantes que solicitam apoio de acessibilidade ou organiza{\c c}{\~a}o & Caso~3 -- Qualquer {\'a}rea com entrega escrita ou c{\'o}digo-fonte \\
    \addlinespace
