...
\begin{enumerate}
  ...
  \item \textbf{Seletor Superior de Modelos e Agentes}: Um menu suspenso permite alternar rapidamente entre provedores (Anthropic, OpenAI, modelos gratuitos do OpenCode ou Ollama local) e definir se a tarefa ser{\'a} conduzida pelo agente geral ou por um subagente especializado (e.g., \texttt{construtor-de-avaliacoes}).
\end{enumerate}
...
\textbf{Seguran{\c c}a e Controle de Vers{\~a}o}: Ao usar a interface gr{\'a}fica, mantenha o diret{\'o}rio do curso sob controle de vers{\~a}o Git. A interface do OpenCode exibe automaticamente o estado dos ramos e altera{\c c}{\~o}es n{\~a}o salvas, conferindo seguran{\c c}a total contra exclus{\~o}es acidentais.
