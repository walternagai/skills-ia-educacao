...
\begin{itemize}
  \item \emph{Humanas (Hist{\'o}ria, Letras, Filosofia, Sociologia, Direito)}: \path{ia-educacao-avaliacao} (redesenhar ensaios e quest{\~o}es discursivas), \path{ia-educacao-avaliacao-oral} (semin{\'a}rios e argui{\c c}{\~o}es), \path{ia-educacao-integridade-academica} (pol{\'i}tica de IA para trabalhos escritos), \path{ia-educacao-escrita} (revisar textos preservando a voz autoral) e \path{ia-educacao-estudo-de-caso} (casos jur{\'i}dicos, hist{\'o}ricos e cl{\'i}nicos);
