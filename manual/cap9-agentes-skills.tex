...
\begin{dicaopencode}
\textbf{Kit inicial (primeira semana)}: comece por estes e ignore o resto do cat{\'a}logo por enquanto. Skills: \path{aias-consultant} (qual n{\'i}vel AIAS usar), \path{ia-educacao-bloom} (verbos e n{\'i}vel cognitivo), \path{ia-educacao-rubrica} (rubrica anal{\'i}tica), \path{ia-educacao-avaliacao} (redesenhar a atividade) e \path{ia-educacao-feedback} (devolutiva \emph{Feed Up/Back/Forward}). Subagentes: \path{@planejador-pedagogico} (planejar a disciplina) e \path{@construtor-de-avaliacoes} (montar prova com gabarito). Como escolher: descreva a tarefa com suas palavras ou digite \texttt{/} para skills e \texttt{@} para subagentes; o cat{\'a}logo completo abaixo {\'e} refer{\^e}ncia, n{\~a}o leitura obrigat{\'o}ria.
\end{dicaopencode}

\begin{adaptacaoarea}
\textbf{Trilhas por grande {\'a}rea do conhecimento}: al{\'e}m do kit inicial acima, que serve a todas as {\'a}reas, inclua as skills da sua grande {\'a}rea no repert{\'o}rio da primeira quinzena:
\begin{itemize}
  \item \emph{Humanas (Hist{\'o}ria, Letras, Filosofia, Sociologia)}: \path{ia-educacao-avaliacao} (redesenhar ensaios e quest{\~o}es discursivas), \path{ia-educacao-avaliacao-oral} (semin{\'a}rios e argui{\c c}{\~o}es), \path{ia-educacao-integridade-academica} (pol{\'i}tica de IA para trabalhos escritos), \path{ia-educacao-escrita} (revisar textos preservando a voz autoral) e \path{ia-educacao-estudo-de-caso} (estudos de caso hist{\'o}ricos e sociais);
  \item \emph{Sa{\'u}de (Enfermagem, Medicina, Farm{\'a}cia, Psicologia)}: \path{ia-educacao-simulacao} (cen{\'a}rios cl{\'i}nicos e \emph{role-playing}), \path{ia-educacao-tbl} (equipes, padr{\~a}o em sa{\'u}de), \path{ia-educacao-mcq} (itens diagn{\'o}sticos por equ{\'i}voco cl{\'i}nico), \path{ia-educacao-supervisao-humana} (decis{\~o}es de sa{\'u}de sob controle humano) e \path{ia-educacao-governanca-dados} (laudos e dados de pacientes);
  \item \emph{Sociais Aplicadas (Administra{\c c}{\~a}o, Direito, Economia, Contabilidade, Servi{\c c}o Social)}: \path{ia-educacao-planejamento-reverso} (alinhamento ao PPC), \path{ia-educacao-avaliacao-projeto} (planos de neg{\'o}cios e est{\'a}gios), \path{ia-educacao-portfolio} (portf{\'o}lio reflexivo), \path{ia-educacao-visualizacao-dados} (gr{\'a}ficos para relat{\'o}rios e pareceres) e \path{ia-educacao-pesquisa} (revis{\~a}o de literatura aplicada);
  \item \emph{Engenharias e Ci{\^e}ncias Exatas}: \path{ia-educacao-banco-questoes} (banco por n{\'i}vel de Bloom), \path{ia-educacao-mcq} (distratores por equ{\'i}voco de c{\'a}lculo), \path{ia-educacao-rubrica} (memoriais e projetos), \path{ia-educacao-peer-instruction} (vota{\c c}{\~a}o em sala) e \path{ia-educacao-visualizacao-dados} (relat{\'o}rios t{\'e}cnicos).
\end{itemize}
Como nos casos do Cap{\'i}tulo~\ref{cap:casos-de-uso}, basta descrever a tarefa com suas palavras: a detec{\c c}{\~a}o sem{\^a}ntica seleciona a skill -- n{\~a}o {\'e} preciso decorar slugs.
\end{adaptacaoarea}
...
Quando o campo \texttt{model} n{\~a}o {\'e} informado, o subagente herda o modelo selecionado pelo agente principal. Essa op{\c c}{\~a}o mant{\'e}m o acervo independente de provedor e evita fixar no arquivo um identificador que pode n{\~a}o existir na instala{\c c}{\~a}o do docente.
...
\begin{itemize}
  ...
  \item \textbf{Salvaguarda de Terceiros}: segue protocolo obrigat{\'o}rio de remo{\c c}{\~a}o de identificadores pessoais antes de processar entregas, veda{\c c}{\~a}o de dados sens{\'i}veis e de documentos sigilosos sem autoriza{\c c}{\~a}o expressa (Cap{\'i}tulo~\ref{cap:etica-transparencia});
  \item \textbf{Permiss{\~o}es}: Leitura e escrita (\texttt{edit: allow}, \texttt{bash: allow});
...
\begin{itemize}
  ...
  \item \textbf{Salvaguarda de Terceiros}: descreve a necessidade pedag{\'o}gica -- nunca o diagn{\'o}stico -- ao adaptar a linguagem, e segue o mesmo protocolo de pseudonimiza{\c c}{\~a}o e veda{\c c}{\~a}o de dados sens{\'i}veis do aplicador de rubricas;
  \item \textbf{Permiss{\~o}es}: Leitura e escrita (\texttt{edit: allow}, \texttt{bash: allow});
...
\begin{itemize}
  ...
  \item \textbf{Permiss{\~o}es}: Leitura e escrita (\texttt{edit: allow}, \texttt{bash: allow});
  \item \textbf{Skills Orquestradas}: \path{aias-consultant} ({\^a}ncora das restri{\c c}{\~o}es de schema AIAS); as demais skills entram como objetos de cria{\c c}{\~a}o, refatora{\c c}{\~a}o e auditoria.
\end{itemize}

A Tabela~\ref{tab:agentes-sintese} sintetiza os seis subagentes, suas permiss{\~o}es, insumos e entreg{\'a}veis.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash\ttfamily\footnotesize}p{5.4cm}X}
    ...
    \addlinespace
    \path{ia-educacao-superior} & Incorpora{\c c}{\~a}o na gradua{\c c}{\~a}o e p{\'o}s-gradua{\c c}{\~a}o, abrangendo ensino, pesquisa e extens{\~a}o; protocolo de esclarecimento por bancas. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash\ttfamily\footnotesize}p{5.4cm}X}
    ...
    \addlinespace
    \path{ia-educacao-tbl} & \emph{Team-Based Learning}: elabora{\c c}{\~a}o de iRAT, gRAT e resolu{\c c}{\~a}o em equipe. \\
    \addlinespace
...
Esta categoria responde {\`a} pergunta das salvaguardas: \emph{sob quais condi{\c c}{\~o}es a IA pode ser utilizada?} Ela re{\'u}ne o arcabou{\c c}o que protege docentes e discentes -- fundamentos {\'e}ticos, governan{\c c}a e prote{\c c}{\~a}o de dados, supervis{\~a}o humana, transpar{\^e}ncia dos modelos, mitiga{\c c}{\~a}o de vieses, seguran{\c c}a digital e integridade acad{\^e}mica. Para o docente, estas skills funcionam como um guia de conformidade: antes de implementar qualquer pr{\'a}tica com IA, vale consultar as diretrizes aqui reunidas, que traduzem o \emph{Referencial do MEC}, a legisla{\c c}{\~a}o brasileira (como a LGPD) e as \emph{normas institucionais da UNIFEI} -- em especial o Guia de refer{\^e}ncia para uso de IAG e a Pol{\'i}tica de Integridade do CNPq \cite{unifei2026guia,cnpq2026integridade} -- em orienta{\c c}{\~o}es pr{\'a}ticas para a sala de aula e para a gest{\~a}o institucional.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash\ttfamily\footnotesize}p{5.4cm}X}
    ...
    \addlinespace
    \path{ia-educacao-integridade-academica} & Diretrizes de integridade e conduta {\'e}tica (pl{\'a}gio, autopl{\'a}gio, fabrica{\c c}{\~a}o e falsifica{\c c}{\~a}o de dados), contrato de autoria respons{\'a}vel e declara{\c c}{\~a}o de uso de IAG conforme o Guia da UNIFEI. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
Esta categoria responde {\`a} pergunta da execu{\c c}{\~a}o: \emph{o que o docente precisa produzir ou corrigir agora?} Ela concentra os instrumentos prontos da rotina acad{\^e}mica -- avalia{\c c}{\~o}es (formativa, diagn{\'o}stica, por compet{\^e}ncias, oral, em grupo, de projeto e autoavalia{\c c}{\~a}o), rubricas, bancos de quest{\~o}es e MCQs, feedback, portf{\'o}lios, bem como t{\'e}cnicas de racioc{\'i}nio conciso e verifica{\c c}{\~a}o independente (Chain of Draft e Chain of Verification) e apoios para pesquisa, escrita acad{\^e}mica e visualiza{\c c}{\~a}o de dados. {\'E} a categoria mais numerosa justamente por reunir, em um {\'u}nico lugar, a maioria dos chamados \emph{de uso imediato} que o docente faz ao OpenCode no dia a dia. \'E aqui que residem tamb{\'e}m a consultoria da Escala AIAS (\path{aias-consultant}) e as skills de suporte {\`a} gest{\~a}o institucional e {\`a} inova{\c c}{\~a}o educacional.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash\ttfamily\footnotesize}p{5.4cm}X}
    ...
    \textbf{\textnormal{\textbf{Skill (Slug)}}} & \textbf{Objetivo e Escopo Pedag{\'o}gico} \\
    \midrule
    \path{aias-consultant} & Consultoria especializada nos 5 n{\'i}veis da Escala AIAS e pol{\'i}ticas de avalia{\c c}{\~a}o; enunciados declaram se o uso {\'e} permitido, restrito ou vedado. \\
    ...
    \path{ia-educacao-avaliacao-oral} & Roteiros, rubricas e protocolos para semin{\'a}rios e defesas de projetos, incluindo esclarecimentos sobre uso de IAG na argui{\c c}{\~a}o. \\
    ...
    \path{ia-educacao-rubrica} & Constru{\c c}{\~a}o de rubricas anal{\'i}ticas com r{\'o}tulos neutros e coer{\^e}ncia AIAS; uso de IAG restrito a insumos n{\~a}o sigilosos. \\
    \path{ia-educacao-feedback} & Design de feedback formativo no modelo \emph{Feed Up/Back/Forward}, com salvaguarda de dados de terceiros. \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash\ttfamily\footnotesize}p{5.4cm}X}
    ...
    \path{ia-educacao-personalizacao} & Trilhas de aprendizagem diferenciadas conforme o ritmo e dificuldades do estudante. \\
    ...
    \path{ia-educacao-pesquisa} & Metodologia de pesquisa cient{\'i}fica, revis{\~a}o integrativa e an{\'a}lise com IA; declara{\c c}{\~a}o de uso de IAG no formato institucional. \\
    \path{ia-educacao-escrita} & Escrita acad{\^e}mica assistida por IA garantindo preserva{\c c}{\~a}o da voz autoral; vedada a gera{\c c}{\~a}o integral sem revis{\~a}o. \\
