...
\begin{itemize}
  ...
  \item Situar as diretrizes institucionais da UNIFEI e a Pol{\'i}tica de Integridade do CNPq no uso de IAG;
...
Al{\'e}m dos marcos internacionais e nacionais, este acervo observa as \textbf{normas institucionais da UNIFEI} para o uso de IAG, em especial o \emph{Guia de refer{\^e}ncia: uso de ferramentas de intelig{\^e}ncia artificial generativa em trabalhos acad{\^e}micos e na pesquisa} \cite{unifei2026guia}, cujos quatro princ{\'i}pios -- integridade cient{\'i}fica, transpar{\^e}ncia, conduta {\'e}tica e responsabilidade do(a) pesquisador(a) -- orientam as diretrizes pr{\'a}ticas deste cap{\'i}tulo, e a \emph{Pol{\'i}tica de Integridade na Atividade Cient{\'i}fica do CNPq} \cite{cnpq2026integridade}, que fundamenta o guia. Delas decorrem as veda{\c c}{\~o}es que o acervo incorpora: a ferramenta n{\~a}o {\'e} autora nem coautora; textos n{\~a}o podem ser integralmente gerados por IA nem apresentados sem revis{\~a}o humana; dados sens{\'i}veis, informa{\c c}{\~o}es pessoais e conte{\'u}dos sigilosos ou de terceiros n{\~a}o entram em ferramentas de IAG; e o uso, quando significativo, deve ser declarado.
...
A UNIFEI disponibiliza a ferramenta \textbf{Turnitin} para verifica{\c c}{\~a}o de originalidade e preven{\c c}{\~a}o de pl{\'a}gio \cite{unifei2026guia}. Seu uso deve ser \emph{preventivo e formativo} -- apoiar o estudante a corrigir a atribui{\c c}{\~a}o de fontes antes da submiss{\~a}o final -- e nunca constituir prova isolada de m{\'a} conduta, pelos mesmos motivos que desaconselham os detectores de IA: toda suspeita exige di{\'a}logo com o estudante e apura{\c c}{\~a}o pelo fluxo institucional.
...
\begin{itemize}
  \item \textbf{Minimiza{\c c}{\~a}o e Pseudonimiza{\c c}{\~a}o}: Antes de submeter trabalhos de estudantes para an{\'a}lise ou gera{\c c}{\~a}o de feedback por modelos de nuvem, remova nomes completos, n{\'u}meros de matr{\'i}cula, CPFs, endere{\c c}os eletr{\^o}nicos e metadados desnecess{\'a}rios. Substitua o nome por um c{\'o}digo quando isso for suficiente, mas n{\~a}o chame esse procedimento de anonimiza{\c c}{\~a}o se ainda for poss{\'i}vel reidentificar a pessoa;
  \item \textbf{Vedada a Inser{\c c}{\~a}o de Dados Sens{\'i}veis}: Jamais insira em \emph{prompts} informa{\c c}{\~o}es sobre laudos m{\'e}dicos discentes, condi{\c c}{\~o}es socioecon{\^o}micas vulner{\'a}veis, cren{\c c}as religiosas ou processos disciplinares em andamento. Para adaptar a linguagem do feedback, descreva a necessidade pedag{\'o}gica solicitada pelo estudante, sem registrar seu diagn{\'o}stico;
  \item \textbf{Modelos Locais com Verifica{\c c}{\~a}o}: Para dados de pesquisas acad{\^e}micas com exig{\^e}ncia de sigilo {\'e}tico (aprovadas por Comit{\^e} de {\'E}tica em Pesquisa -- CEP), avalie modelos executados localmente via Ollama (\url{http://localhost:11434}). O processamento local reduz o envio para provedores externos, mas n{\~a}o elimina riscos de logs, extens{\~o}es, backups, acesso ao computador ou configura{\c c}{\~a}o incorreta;
  \item \textbf{Governan{\c c}a}: Defina finalidade, prazo de reten{\c c}{\~a}o, local de armazenamento, controle de acesso e procedimento de descarte. Em caso de d{\'u}vida, consulte a pol{\'i}tica institucional e o encarregado pelo tratamento de dados antes de usar trabalhos reais.
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Vi{\'e}s de Concord{\^a}ncia (\emph{Sycophancy})}: Os LLMs tendem a concordar com as premissas do usu{\'a}rio, mesmo quando o docente comete um equ{\'i}voco intencional no \emph{prompt} (por exemplo, afirmando que uma integral impr{\'o}pria diverge quando na verdade ela converge, ou atribuindo a um julgado uma tese que ele n{\~a}o adotou).
