...
\begin{enumerate}
  ...
  \item \textbf{Vi{\'e}s de Concord{\^a}ncia (\emph{Sycophancy})}: Os LLMs tendem a concordar com as premissas do usu{\'a}rio, mesmo quando o professor comete um equ{\'i}voco intencional no \emph{prompt} (por exemplo, afirmando que uma integral impr{\'o}pria diverge quando na verdade ela converge, ou atribuindo a um julgado uma tese que ele n{\~a}o adotou).
