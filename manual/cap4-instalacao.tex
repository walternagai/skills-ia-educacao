...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{p{2.2cm}p{4.6cm}p{4.6cm}X}
    \toprule
    \textbf{Sistema} & \textbf{Terminal Recomendado} & \textbf{M{\'e}todos de Instala{\c c}{\~a}o} & \textbf{Diret{\'o}rio das Skills} \\
    \midrule
    \textbf{Windows} & PowerShell 5.1+/7, Windows Terminal ou Git Bash & Script cURL via WSL2, Scoop ou Chocolatey & \texttt{C:\textbackslash{}Users\textbackslash{}<usuario>\textbackslash{}.\textbackslash{}config\textbackslash{}opencode\textbackslash{}skills} \\
    \addlinespace
    \textbf{Linux} & Bash ou Zsh & Script cURL, npm/pnpm/bun & \texttt{\~{}/.config/opencode/skills} \\
    \addlinespace
    \textbf{macOS} & Terminal.app ou iTerm 2 (Zsh padr{\~a}o) & Script cURL, npm/pnpm/bun, Homebrew & \texttt{\~{}/.config/opencode/skills} \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{center}
  ...
  \begin{tabularx}{\linewidth}{p{2.4cm}X}
    ...
    \midrule
    Linux e macOS/WSL2 & \texttt{\~{}/.config/opencode/skills/<slug>/SKILL.md} \\
    \addlinespace
    Windows nativo & \texttt{C:\textbackslash{}Users\textbackslash{}<usuario>\textbackslash{}.config\textbackslash{}opencode\textbackslash{}skills\textbackslash{}<slug>\textbackslash{}SKILL.md} \\
    \bottomrule
  \end{tabularx}
\end{center}
