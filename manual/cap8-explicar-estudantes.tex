...
\begin{itemize}
  ...
  \item Implantar o protocolo de declara{\c c}{\~a}o de uso de IA nas atividades avaliativas, em conformidade com o Guia institucional da UNIFEI;
  \item Preparar estudantes e bancas para esclarecimentos sobre o uso de IAG em defesas.
\end{itemize}
\end{objetivos}

\section{O Contrato Pedag{\'o}gico da Aula Inaugural}

O maior obst{\'a}culo enfrentado por estudantes em rela{\c c}{\~a}o {\`a} intelig{\^e}ncia artificial n{\~a}o {\'e} a complexidade t{\'e}cnica das ferramentas, mas a \textbf{ambiguidade normativa}. Quando a institui{\c c}{\~a}o ou o docente n{\~a}o explicitam com clareza o que {\'e} permitido e o que {\'e} vedado, cria-se um ambiente de inseguran{\c c}a, medo e desonestidade velada \cite{perkins2024aias}. Nessa dire{\c c}{\~a}o, o marco de compet{\^e}ncias em IA para estudantes da UNESCO orienta tratar o letramento em IA como forma{\c c}{\~a}o para o uso cr{\'i}tico e respons{\'a}vel da tecnologia \cite{unesco2024framework}.

O primeiro dia de aula {\'e} o momento determinante para estabelecer o \textbf{contrato pedag{\'o}gico de transpar{\^e}ncia}. Em vez de iniciar o semestre amea{\c c}ando puni{\c c}{\~o}es com base em detectores ineficazes, o docente deve assumir a lideran{\c c}a do di{\'a}logo:
...
A Escala AIAS n{\~a}o deve permanecer como um documento t{\'e}cnico restrito aos docentes. Ela deve ser explicada em linguagem direta e afirmativa aos estudantes, conforme sugerido na Tabela~\ref{tab:aias-discente}.

Antes de apresentar a tabela, informe tr{\^e}s coisas separadamente: se o uso de IA generativa est{\'a} \textbf{permitido, restrito ou vedado} naquela atividade (evite o ``IA sim/n{\~a}o'' gen{\'e}rico); se seu uso {\'e} opcional ou obrigat{\'o}rio; e quais tecnologias assistivas e adapta{\c c}{\~o}es autorizadas permanecem garantidas, que n{\~a}o devem ser confundidas com o uso de IA generativa.
...
\textbf{Conformidade com o Guia Institucional}: para trabalhos acad{\^e}micos e cient{\'i}ficos (TCC, disserta{\c c}{\~a}o, tese, artigo, relat{\'o}rio de pesquisa), a UNIFEI \cite{unifei2026guia} orienta uma declara{\c c}{\~a}o mais completa: uma se{\c c}{\~a}o no in{\'i}cio do trabalho, intitulada \textbf{``Uso de Intelig{\^e}ncia Artificial Generativa''}, informando a(s) ferramenta(s), a finalidade, a extens{\~a}o e o tipo de contribui{\c c}{\~a}o. Quando o uso for significativo para a constru{\c c}{\~a}o dos resultados (por exemplo, em etapas metodol{\'o}gicas ou de an{\'a}lise de dados), o guia recomenda detalhar tamb{\'e}m no corpo do texto e apresentar os \emph{prompts} utilizados -- ao menos os das intera{\c c}{\~o}es iniciais -- em nota de rodap{\'e} ou Ap{\^e}ndice. A ferramenta n{\~a}o {\'e} autora nem coautora do trabalho, e a responsabilidade pela precis{\~a}o, originalidade e integridade permanece integralmente com o(a) autor(a). As skills \path{ia-educacao-pesquisa} e \path{ia-educacao-integridade-academica} geram esse texto no formato exigido.
\end{atencaopedagogica}

Essa sistem{\'a}tica substitui o medo da puni{\c c}{\~a}o pela cultura da responsabilidade acad{\^e}mica, alinhando a conduta discente aos princ{\'i}pios de integridade cient{\'i}fica defendidos pelo Minist{\'e}rio da Educa{\c c}{\~a}o \cite{brasil2026referencial} e {\`a}s normas institucionais da UNIFEI \cite{unifei2026guia}.
...
\section{Esclarecimentos sobre o Uso de IAG em Bancas e Defesas}

As normas institucionais da UNIFEI \cite{unifei2026guia} preveem que orientadores(as), membros de bancas examinadoras e avaliadores(as) podem solicitar esclarecimentos adicionais sobre o uso de IAG sempre que houver d{\'u}vida sobre autoria, originalidade, metodologia, an{\'a}lise de dados ou integridade acad{\^e}mica do trabalho. {\'E} mais uma raz{\~a}o para que a declara{\c c}{\~a}o e o registro de \emph{prompts} sejam cultivados desde o in{\'i}cio: eles tornam a conversa uma demonstra{\c c}{\~a}o tranquila de autoria, e n{\~a}o uma suspeita.

Para o estudante, vale a orienta{\c c}{\~a}o pr{\'a}tica: saiba explicar, sem consultar, o que a IA fez e o que voc{\^e} decidiu em cada etapa; guarde os \emph{prompts} iniciais; e encare a argui{\c c}{\~a}o como parte da defesa do trabalho. Para a banca, a orienta{\c c}{\~a}o {\'e} conduzir o esclarecimento de forma formativa, com perguntas sobre o processo, usando a declara{\c c}{\~a}o de uso como ponto de partida -- nunca detectores de IA como prova isolada -- e encaminhar qualquer decis{\~a}o sobre m{\'a} conduta ao fluxo institucional, e n{\~a}o ao ju{\'i}zo monocr{\'a}tico do avaliador. O roteiro completo de argui{\c c}{\~a}o est{\'a} na skill \path{ia-educacao-avaliacao-oral}, e o protocolo de bancas para TCC e p{\'o}s-gradua{\c c}{\~a}o, na \path{ia-educacao-superior}.
