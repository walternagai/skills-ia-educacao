...
\begin{conceitochave}
\textbf{Invoca{\c c}{\~a}o por Barra (\emph{Slash Command})}: Toda skill deste acervo {\'e} acionada pelo usu{\'a}rio por meio da sintaxe \texttt{/nome-da-skill}, com a barra antecedendo o slug can{\^o}nico. Por exemplo, a skill de rubricas {\'e} invocada como \texttt{/ia-educacao-rubrica} e a consultoria da Escala AIAS como \texttt{/aias-consultant}. Tamb{\'e}m {\'e} poss{\'i}vel mencionar a skill diretamente no texto do \emph{prompt} (ex.: ``use a skill \texttt{ia-educacao-rubrica}''); nesse caso, o modelo reconhece o identificador e aciona a ferramenta interna automaticamente.
\end{conceitochave}
