...
theme: default
paginate: true
header: 'Skills IA na Educação'
footer: 'Acervo alinhado ao Referencial MEC (2026)'
size: 16:9
style: |
  section {
    font-size: 25px;
...
![Hub Chart](assets/hub-chart.svg)

---

# O maior hub: `aias-consultant`

![h:480 center](assets/hub-star.svg)

---

# Relação entre os principais hubs

![h:480 center](assets/hub-network.svg)
